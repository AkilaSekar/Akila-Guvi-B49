...
.then((val)=>{   
     ...
     myDiv4.setAttribute("class","container1");
     ...
     myDiv5.setAttribute("class","container1");
     ...
     myDiv6.setAttribute("class","container1");
     ...
     myDiv7.setAttribute("class","container1");
     ...
     myDiv8.setAttribute("class","container1");
     myDiv8.innerHTML=`8.${val[0].meanings[0].definitions[7].definition}`;
     myDiv.appendChild(myDiv8) 

     const myDiv9 = document.createElement("div");
     myDiv9.setAttribute("class","container1");
     ...
     myDiv10.setAttribute("class","container1");
     ...
     myDiv11.setAttribute("class","container1");
     ...
     synonymsHead.innerHTML=`Synonym of the word "WORLD"`;
     ...
     partHead.innerHTML=`Part of the Speech`;
